...
public class UserHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        booksTable.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        ...
        downloadedBooksTable.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new UserHome("ADMIN").setVisible(true);// the admin is the default user. if the proggram is run in this file
            }
        });
    }
